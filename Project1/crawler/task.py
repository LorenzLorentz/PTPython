...
def makedir():
    ...
    os.makedirs("Data/Song", exist_ok=True)
    os.makedirs("Data/Singer", exist_ok=True)
    os.makedirs("Data/Song/Image", exist_ok=True)
    os.makedirs("Data/Singer/Image", exist_ok=True)
