...
async def data_import(request:Request, file:UploadFile=File(...), db_session=Depends(get_db)):
    ...
    if not file.filename.endswith('.json'):
        raise APIException(status_code=401, msg="只支持.json文件")
    ...
    try:
        ...
        raise APIException(status_code=402, msg="编码错误")
    except json.JSONDecodeError:
        raise APIException(status_code=404, msg="格式无效, 无法解析")
    ...
    try:
        ...
        raise APIException(status_code=405, msg="参数错误")
